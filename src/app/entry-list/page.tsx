...
export default function EntryList() {
  return (
    <Container size="lg" py="xl">
      <Box mb="xl">
        <Title order={2} ta="center">エントリー済み一覧</Title>
      </Box>
      <Box ta="right" mb={40}>
      ...
      <Table verticalSpacing="sm" withTableBorder withColumnBorders>
        <Table.Thead>
          <Table.Tr>
          <Table.Th bg="blue.1" ta="center">エントリー日</Table.Th>
             <Table.Th bg="blue.1" ta="center">案件名</Table.Th>
             <Table.Th bg="blue.1" ta="center">単価</Table.Th>
          </Table.Tr>
        </Table.Thead>
        <Table.Tbody>
          {ENTRIES_DATA.map((entry) => (
               ...
               <Table.Td ta="center">¥{entry.unitPrice.toLocaleString()}</Table.Td>
             </Table.Tr>
          ))}
        </Table.Tbody>
      </Table>
